CREATE TABLE `vinculacion`.`classes` (
...
CREATE TABLE `vinculacion`.`faculties` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Name` longtext,
  PRIMARY KEY (`Id`)
);

CREATE TABLE `vinculacion`.`periods` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `vinculacion`.`projects` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `ProjectId` longtext,
  `Name` longtext,
...
CREATE TABLE `vinculacion`.`roles` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Name` longtext,
  PRIMARY KEY (`Id`)
);

CREATE TABLE `vinculacion`.`majors` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `MajorId` longtext,
  `Name` longtext,
...
CREATE TABLE `vinculacion`.`users` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `AccountId` longtext,
  `Name` longtext,
  `Password` longtext,
...
CREATE TABLE `vinculacion`.`majorusers` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Major_Id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `vinculacion`.`projectmajors` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Major_Id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `vinculacion`.`sections` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Code` longtext,
...
CREATE TABLE `vinculacion`.`sectionusers` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `vinculacion`.`userroles` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `vinculacion`.`sectionprojects` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Project_Id` bigint(20) DEFAULT NULL,
  `Section_Id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`Id`),
...
CREATE TABLE `vinculacion`.`hours` (
  `Id` bigint(20) NOT NULL AUTO_INCREMENT,
